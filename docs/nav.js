/* Authentication UI Docs — Shared Navigation + Full-text Search */
(function () {
  'use strict';

  const REPO = 'https://github.com/calimero-network/auth-frontend';
  const PAGES_BASE = './';
    ...
    sb.innerHTML = `
      <div class="sidebar-logo">
        <div class="sidebar-logo-inner">
          ...
          <div class="sidebar-logo-text">
            <strong>Calimero <em>Auth</em></strong>
            <span>Authentication UI</span>
          </div>
        </div>
      </div>
      ...
      <div class="sidebar-footer">
        ...
        <div class="sidebar-footer-links">
          <a href="https://github.com/calimero-network/auth-frontend" target="_blank" rel="noopener">
